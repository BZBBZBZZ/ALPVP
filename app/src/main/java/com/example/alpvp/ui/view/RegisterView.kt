    ...
    Box(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                placeholder = { Text("Nama lengkap", color = Color(0xFFBBBBBB), fontSize = 14.sp) },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(48.dp),
            ...
            OutlinedTextField(
                ...
                placeholder = { Text("Minimal 6 karakter", color = Color(0xFFBBBBBB), fontSize = 14.sp) },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(48.dp),
                shape = RoundedCornerShape(12.dp),
            ...
            // Register Button
            Button(
                onClick = { viewModel.register(fullName, password) },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(50.dp),
