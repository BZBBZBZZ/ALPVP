...
// File: data/service/QuizService.kt
interface QuizService {
    @GET("api/quiz/start")
    suspend fun getQuestions(): Response<QuestionWrapper>

    // PERHATIKAN BAGIAN INI: Wajib QuizSubmissionWrapper
    @POST("api/quiz/submit")
    suspend fun submitQuiz(@Body request: SubmitQuizRequest): Response<QuizSubmissionWrapper>
}